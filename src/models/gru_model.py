...
from src.config import GRU_CONFIG, SEQUENCE_LENGTH

logger = logging.getLogger(__name__)

class GRUModel:
    """GRU model for sequential AQI prediction."""
    ...
    def _build_model(self, input_shape):
        ...
        model = Sequential([
            GRU(self.config.get('units_1', 64), return_sequences=True, input_shape=input_shape),
            Dropout(self.config.get('dropout', 0.2)),
            GRU(self.config.get('units_2', 32)),
            Dropout(self.config.get('dropout', 0.2)),
